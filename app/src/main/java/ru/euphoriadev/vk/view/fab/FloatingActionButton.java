package ru.euphoriadev.vk.view.fab;
...
public class FloatingActionButton extends ImageButton {
    ...
    public void attachToListView(@NonNull AbsListView listView, SwipeRefreshLayout refreshLayout) {
        attachToListView(listView, null, null, refreshLayout);
    }

    public void attachToListView(@NonNull AbsListView listView) {
        attachToListView(listView, null, null, null);
    }
    ...
    public void attachToListView(@NonNull AbsListView listView,
        ...
        scrollDetector.setOnScrollListener(onScrollListener, swipeLayout);
